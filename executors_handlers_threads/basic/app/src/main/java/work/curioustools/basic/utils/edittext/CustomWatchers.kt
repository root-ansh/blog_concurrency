...
abstract class CustomWatchers: TextWatcher {
    ...
    class ThrottlingWatcher(private val waitingTime: Long = 200 ): CustomWatchers(){
    ...
    class DebouncingWatcher(private val debounceDelay: Long = 200, private val onUserStartedTypingAgain: () -> Unit = {}) : CustomWatchers() {
        /**
